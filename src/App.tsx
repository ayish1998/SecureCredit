    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      {showMobileSidebar && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          {/* Sidebar */}
          <div className="fixed left-0 top-0 h-full w-80 bg-gray-800 border-r border-gray-700 transform transition-transform duration-300 ease-in-out">
            {/* Sidebar Header */}
            <div className="flex items-center justify-between p-4 border-b border-gray-700">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-lg font-bold text-white">SecureCredit</h1>
                  <p className="text-xs text-gray-400">
                    AI-Powered Financial Security
                  </p>
                </div>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-700">
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className="flex-1 flex items-center justify-center space-x-2 py-2 px-3 bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors"
                >
      ...
      <main className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-4 sm:py-8">
        ...
        {activeTab === "credit" && <CreditScoringDashboard />}

        {activeTab === "security" && (
          <div className="space-y-8">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-bold">
                Device Security & Fingerprinting
              </h2>
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-400">
                  Security Status:{" "}
                  {securityAnalysis?.riskLevel?.toUpperCase() || "CHECKING"}
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
              <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
                ...
                <p className="text-gray-400 mb-4">
                  Advanced browser fingerprinting technology identifies unique
                  device characteristics for fraud prevention.
                </p>
              ...
              <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
                ...
                <p className="text-gray-400 mb-4">
                  Machine learning algorithms analyze device patterns to detect
              ...
              <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
                ...
                <p className="text-gray-400 mb-4">
                  All fingerprinting is done client-side with privacy-first
                  approach, ensuring user data protection.
                </p>
                <ul className="text-sm text-gray-300 space-y-1">
