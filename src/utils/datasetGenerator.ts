...
export class GhanaianFraudDatasetGenerator {
  ...
  private generateLegitimateTransaction(): TrainingDataPoint {
    ...
    return {
      ...
      transactionType: this.randomChoice(['send_money', 'bill_payment', 'airtime', 'merchant_payment']),
      merchantCategory: this.randomChoice(['grocery', 'utilities', 'transport', 'telecom', 'fuel']),
  ...
  private generateSimSwapFraud(): TrainingDataPoint {
    ...
    return {
      ...
      hour: Math.random() < 0.6 ? Math.floor(Math.random() * 6) + 22 : baseTransaction.hour, // Often late night
  ...
  private generateSocialEngineeringFraud(): TrainingDataPoint {
    ...
    return {
      ...
      hour: Math.random() < 0.4 ? Math.floor(Math.random() * 4) + 8 : baseTransaction.hour, // Often business hours
  ...
  private generateAgentFraud(): TrainingDataPoint {
    ...
    return {
      ...
      hour: Math.random() < 0.7 ? (Math.random() < 0.5 ? Math.floor(Math.random() * 6) : Math.floor(Math.random() * 4) + 20) : baseTransaction.hour,
